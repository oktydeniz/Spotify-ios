...
class NewReleasesCollectionViewCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        let imgSize: CGFloat = contentView.height - 10
        
        let albumLabelSize = albumNameLabel.sizeThatFits(CGSize(width: contentView.width-imgSize-10, height: contentView.height-10))
        artistNameLabel.sizeToFit()
        numberOfTracksLabel.sizeToFit()
        albumCoverImageView.frame = CGRect(x: 5, y: 5, width: imgSize, height: imgSize)
